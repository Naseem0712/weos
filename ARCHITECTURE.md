...
```
WEOS/products/<id>/
  product.json          # catalogue: hero, specs, warranty, category
  rules/*.json          # manufacturing source of truth
...
Dashboard · Saved Projects · Window Cart (live SVG preview, autosave, undo/redo) · Product Library · Product Details.
