...
def main() -> None:
    ...
    _ok("Pergola 2D shop drawing" in psvg, "pergola 2D title missing", fails)
    _ok('data-role="post"' in psvg and 'data-role="rafter"' in psvg, "pergola posts/rafters missing", fails)
    _ok('data-role="roof-fill"' in psvg, "pergola roof fill missing", fails)
    _ok("Fixing plate detail" in psvg, "pergola fixing plate detail missing", fails)
    _ok("<polygon" not in psvg, "pergola should not use solid isometric polygons", fails)
    _ok('stroke-width="5"' not in psvg and 'stroke-width="6"' not in psvg, "pergola strokes too solid", fails)
